...
public class LogUtil {
    public static boolean LOG = ResourceUtil.getAppBooleanRes(BaseApplication.getApplication(), "is_debug", true);
    ...
    public static void header(String TAG) {
        Log.e(TAG,"\r\n" + LogFormat.TOP_HORIZONTAL_BORDER);
    }

    public static void footer(String TAG) {
        Log.e(TAG,"\r\n" + LogFormat.BOTTOM_HORIZONTAL_BORDER);
    }
}
